  ...
  if(!started) return <main className="landing" dir="rtl">
    ...
    <section className="hero">
      ...
      <div className="inspectionVisual" aria-label="תרשים אזורי בדיקה ברכב">
        <div className="drawingTitle"><span>תרשים בדיקה ראשוני</span><b>01</b></div>
        ...
        <div className="inspectionSeal"><span>בודקים לפני</span><b>שקונים</b></div>
      </div>
    </section>
